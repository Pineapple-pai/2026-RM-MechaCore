...
void ui_update_ROT() {
    ...
    if (mode == 1) ui_ROT_Gimbal_Normal->color = 1; // 黄色
    ...
    ui_ROT_Ungroup_Super->color = sup ? 1 : 2; // 激活时为黄色
    ui_ROT_Ungroup_Fri->color = fri ? 1 : 2;   // 激活时为黄色
